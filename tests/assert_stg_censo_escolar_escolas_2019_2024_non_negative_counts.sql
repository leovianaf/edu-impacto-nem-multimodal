...
where
    coalesce(qt_salas_utilizadas, 0) < 0
    or coalesce(qt_mat_bas, 0) < 0
    or coalesce(qt_mat_inf, 0) < 0
    or coalesce(qt_mat_fund, 0) < 0
    or coalesce(qt_mat_med, 0) < 0
